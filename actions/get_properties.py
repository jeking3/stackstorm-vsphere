...
class GetProperties(BaseAction):
    ...
    def run(self, type, property, id, vsphere=None):
        ...
        return collector.collect(self.si_content, type, property, id)
